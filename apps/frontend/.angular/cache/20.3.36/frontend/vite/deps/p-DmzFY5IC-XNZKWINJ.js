...
var D = (o2, n, r, a2, e, s, d2 = false, c2 = 0, l3 = true) => __async(null, null, function* () {
  if (!r && !a2) return;
  ...
  if (u2(o2, n, true, f2.inputSafeY, d2), v(n), s && r && (y = f2.scrollPadding, h(r, y)), "undefined" != typeof window) {
    let a3;
    const e2 = () => __async(null, null, function* () {
...
var x = (t3, i2) => __async(null, null, function* () {
  if (void 0 === o) return;
  const l3 = "ios" === i2, f2 = "android" === i2, w2 = t3.getNumber("keyboardHeight", 290), m3 = t3.getBoolean("scrollAssist", true), h2 = t3.getBoolean("hideCaretOnScroll", l3), b2 = t3.getBoolean("inputBlurring", false), y2 = t3.getBoolean("scrollPadding", true), v2 = Array.from(o.querySelectorAll("ion-input, ion-textarea")), x2 = /* @__PURE__ */ new WeakMap(), K = /* @__PURE__ */ new WeakMap(), M = yield t2.getResizeMode(), j = (n) => __async(null, null, function* () {
...
//# sourceMappingURL=p-DmzFY5IC-XNZKWINJ.js.map
